...
export interface CompetitionSeed {
  ...
  reputation: number;
  rounds: number;
  split?: { regularRounds: number; regularLastWeek: number; upperTeams: number; upperRounds: number; lowerRounds: number };
...
export const COMPETITIONS: CompetitionSeed[] = [
  ...
  // Israel
  { id: 'il.1', name: 'Ligat HaAl', nameHe: 'ליגת העל', country: 'ISR', tier: 1, reputation: 54, rounds: 2, split: { regularRounds: 2, regularLastWeek: 34, upperTeams: 6, upperRounds: 2, lowerRounds: 1 }, relegationAuto: 2, relegationTo: 'il.2', uclQual: 1, uelQual: 1, ueclQual: 2, cards: ISRAEL_CARDS, manual: true },
  { id: 'il.2', name: 'Liga Leumit', nameHe: 'ליגה לאומית', country: 'ISR', tier: 2, reputation: 40, rounds: 2, split: { regularRounds: 2, regularLastWeek: 36, upperTeams: 8, upperRounds: 1, lowerRounds: 1 }, promotionAuto: 2, promotionTo: 'il.1', relegationAuto: 2, relegationTo: 'il.3', cards: ISRAEL_CARDS, manual: true },
