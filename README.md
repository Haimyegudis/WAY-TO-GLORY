...
```bash
npm test               # 111 בדיקות מנוע
npm run test:e2e       # מסלול דפדפן מלא + בדיקות נגישות axe
...
- **עונת הקריירה**: מתחילה ב-2026/27. הכניסה לסגל הבוגר מתחילה בשלושה שבועות של
  מחנה אימונים ומשחקי הכנה; הליגה ואירופה נפתחות רק לאחר שהמאמן בחן את השחקן.
- **ליגות ומועדונים**: 608 מועדונים ב-39 מסגרות ליגה. תמונת המקור האחרונה הזמינה
  מ-[openfootball](https://github.com/openfootball) היא 2025/26; היא משמשת בסיס לעוצמות
  המועדונים ולא מוצגת בטעות כנתוני 2026/27. הליגות הישראליות והדרגים החסרים נכתבו ידנית.
